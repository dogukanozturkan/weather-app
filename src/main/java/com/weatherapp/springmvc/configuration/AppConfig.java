package com.weatherapp.springmvc.configuration;
...
import com.weatherapp.springmvc.converter.RoleToUserProfileConverter;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.weatherapp.springmvc")
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public CharacterEncodingFilter characterEncodingFilter() {
		...
		characterEncodingFilter.setEncoding("ISO-8859-9");
